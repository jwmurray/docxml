...
//! edit via lazily parsed parts), and inline images ([`Picture`] — read existing pictures,
//! add new ones with EMU geometry, creating the media part, content-type, and relationship)
...
pub use api::{
    Alignment, BreakType, Cell, Document, HeaderFooter, Length, LineSpacing, Paragraph, Picture,
    Pt, RgbColor, Row, Run, Section, TabAlignment, TabLeader, Table, VMerge,
};
